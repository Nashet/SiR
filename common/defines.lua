...
country = {
	...
	MIN_DELAY_BETWEEN_REFORMS = 12, -- months
...
diplomacy = {
	...
	DISHONORED_CALLALLY_PRESTIGE_PENALTY = -100,
	BASE_TRUCE_MONTHS = 60,
	MAX_INFLUENCE = 100,
	WARSUBSIDIES_PERCENT = 0.98, -- How many percent of imports you are going to pay each day(mil. constructions and mil. maintainence)
...
pops = {
	...
	MIL_HIT_FROM_CONQUEST = 10, -- how much militancy grows in a province if taken without being core.
	...
	MIL_ON_REB_MOVE = 8,
	POPULATION_SUPPRESSION_FACTOR = 0, -- controls base pop size for factor of supression/radicalness cost. zero  disables the feature and jsut uses radicalness
